    ...
    For example, the length of LIS for {10, 22, 9, 33, 21, 50, 41, 60, 80} is 6 and LIS is {10, 22, 33, 50, 60, 80}.*/
	 ...
	 static int lis(int arr[],int n)
	 {
	       ...
	       /* Initialize LIS values for all indexes */
	        ...
	        //below loop is optional if you want to print elements from array in decending order
	        //if we dont want to print it we dont need result variable we can return max directly
	        for (i = n-1; i>=0; i--){
	        	if (lis[i] == max){
